...
tocarNota(pca1,A5,500);

  delay(50); 
tocarNota(pca1,A5,500);

tocarNota(pca1,C6,250);

tocarNota(pca1,E5,250);

tocarNota(pca1,C5,1000);
...
tocarNota(pca1,E5,500);

tocarNota(pca1,F5,250);
...
tocarNota(pca1,C5,250);

tocarNota(pca1,B4,1000);

tocarNota(pca1,B4,500);

tocarNota(pca1,D4,500);

tocarNota(pca1,F4,250);

tocarNota(pca1,G4,250);
...
void tocarNota(Adafruit_PWMServoDriver placa,int nota, int duracion){
	...
	int duracionCalculada = duracion * (60.0 / 90);
